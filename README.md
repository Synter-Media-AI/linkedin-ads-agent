...
Manage LinkedIn Ads campaigns with AI agents via MCP.

 `linkedin-ads` `b2b-advertising` `lead-generation` `mcp` `ai-agents`

---

## What is this?

Open this repo in **Amp**, **Cursor**, or **VS Code** and your AI agent can immediately manage LinkedIn Ads — no SDK to install, no dependencies. The [Synter MCP server](https://github.com/Synter-Media-AI/mcp-server) is already configured.
...
> List my LinkedIn campaigns with analytics

> Create a sponsored content campaign targeting CTOs in SaaS

> Upload a sponsored image ad

> Pull engagement metrics for the last 14 days

> Create a Matched Audience from company emails
